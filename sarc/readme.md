...
| 0x4 | 4 | [Filename Attributes](#filename-attributes) |
| 0x8 | 4 | Offset into data section (start of file) |
| 0xC | 4 | Offset into data section (end of file) |

## Filename Hash

The filename hash is calculated as follows, using the hash multiplier from the [SFAT header](#sfat-section):
...
| Offset | Size | Description |
| :--- | :--- | :--- | 
| 0x0 | 4 | Magic number (SFNT) |
| 0x4 | 2 | Header size (must be 0x8) |
| 0x6 | 2 | Padding |
| 0x8 |  | Filename table |
