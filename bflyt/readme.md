...
| Offset | Size | Description |
| :--- | :--- | :--- | 
| 0x0 | 4 | [Section Identifier](#section-identifier) |
| 0x4 | 4 | Section Size, including this header |
| 0x8 |  | Section data |

# Section Identifier

The following sections may be found in BFLYT file:
...
| Offset | Size | Description |
| :--- | :--- | :--- | 
| 0x0 | 8 | [Section header](#section-header) |
...
| :--- | :--- | :--- | 
| 0x0 | 8 | [Section Header](#section-header) |
| 0x8 | 1 | Flags: 1 = is visible, 2 = transmit alpha to children |
